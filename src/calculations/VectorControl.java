...
public class VectorControl extends Vector { 
	 ...
	 * @return la multiplicaci�n del escalar por el vector 
	 * @throws NullElementException En caso que los atributos de v1 (i,j,k) sean iguales a 0  
	 */ 
	 ...
	 * @param v1 Vector a obtener sus componentes 
	 * @param v2 Vector a obtener sus componentes 
	 * @return vectorAux la proyecci�n de los vectores v1,v2 
	 * @throws NullElementException En caso que los atributos de v1 o v2 (i,j,k) sean iguales a 0 
	 */  
	...
	/** 
	 * Método para calcular el �rea de un paralelogramo formado por los vectores 
	 * @param v1 Vector a obtener sus componentes 
	 * @param v2 Vector a obtener sus componentes 
	...
	/** 
	 * M�todo para indicar si un vector es igual a otro 
	 * @param v1 Vector a obtener sus componentes 
	 * @return verdadero o falso seg�n sea la comparaci�n 
	 */ 
	...
	/** 
	 * Método para añadir un vector al historial de vectores.
	 * @param history
	 * @param area
	 * @return
	 */
	...
	/**
	 * Genera un vector con elementos aleatorios.
	 * @param history
	 * @return
	 */
	...
	/**
	 * Método que llena el área de texto con los vectores disponibles através de la ejecución del programa.
	 * @param history
	 * @param area
	 */
