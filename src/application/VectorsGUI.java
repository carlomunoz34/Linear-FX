...
public class VectorsGUI extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		multEsc.setOnAction((event)->{
			try {
				int i=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector A por restar"));
				double j=Double.parseDouble(JOptionPane.showInputDialog("Ingrese el número escalar por el cual será multiplicado el vector A"));
				Vector A=history.get(i);
				prepareAnswerField(resTxtArea);
				try {
		...
		magnitud.setOnAction((event)->{
			try {
				int i=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector A para obtener su magnitud"));
				Vector A=history.get(i);
				prepareAnswerField(resTxtArea);
				double x = 0;
				try {
		...
		toUnitary.setOnAction((event)->{
			try {
				int i=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector A a convertir a unitario"));
				Vector A=history.get(i);
				prepareAnswerField(resTxtArea);
				try {
		...
		prodPunto.setOnAction((event)->{
			try {
				int i=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector A para obtener su producto punto"));
				int j=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector B para obtener su producto punto"));
				Vector A=history.get(i);
				Vector B=history.get(j);
				prepareAnswerField(resTxtArea);
				double x = 0;
		...
		prodCruz.setOnAction((event)->{
			try {
				int i=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector A para obtener su producto cruz"));
				int j=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector B para obtener su producto cruz"));
				Vector A=history.get(i);
				Vector B=history.get(j);
				prepareAnswerField(resTxtArea);
				try {
		...
		angulo.setOnAction((event)->{
			try {
				int i=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector A para obtener el ángulo"));
				int j=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector B para obtener el ángulo"));
				Vector A=history.get(i);
				Vector B=history.get(j);
				prepareAnswerField(resTxtArea);
				double x = 0;
		...
		proyeccion.setOnAction((event)->{
			try {
				int i=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector A para obtener la proyección"));
				int j=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector B para obtener la proyección"));
				Vector A=history.get(i);
				Vector B=history.get(j);
				prepareAnswerField(resTxtArea);
				try {
		...
		gramSch.setOnAction((event)->{
			try {
				int i=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector A para obtener el método Gram-Schmidt"));
				int j=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector B para obtener el método Gram-Schmidt"));
				Vector A=history.get(i);
				Vector B=history.get(j);
				prepareAnswerField(resTxtArea);
				try {
		...
		areaPar.setOnAction((event)->{
			try {
				int i=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector A para obtener el área"));
				int j=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector B para obtener el área"));
				int k=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del vector C para obtener el área"));
				Vector A=history.get(i);
				Vector B=history.get(j);
